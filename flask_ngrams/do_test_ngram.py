...
def predict():
    ...
    #get userid
    user_id = all_info["user_id"]
    #to redis
    redis.sadd('user_id',user_id)

    #print('user_id',user_id)
    
    last_word = all_info["last_word"]
    ...
    #print('last_word')
    #connection.commit()
    input_letters = all_info["input_letters"]
    topk = int(all_info["top_k"])
    #print(input_letters)
